...
public class AddressBookSystem {
	public static void main(String[] args) {
		...
		while (exit1) {
			System.out.println(
					"Select option 1:Add address Book 2:open Address Book 3:search by city or state  4 : display users in city or state 5:exit");
			switch (sc.nextInt()) {
			case 1:
			...
			case 2:
				...
				for (i = 0; i < numOfBooks; i++) {
					if (addressBookMain.addressBookName[i].equals(book))
						break;
				}
				if (i == numOfBooks) {
